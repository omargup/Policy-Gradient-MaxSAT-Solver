...
def pg_hypersearch(instance_dir,
    ...
    def define_by_run_func(trial):
        ...
        config = {
            ...
            "log_interval": 10,
            "eval_interval": 10,
            "eval_strategies": [(0, 1), (1, 1), (32, 1), (64, 1), (1, 2), (32, 2), (64, 2)],
        ...
        config["logit_temp"] = None
        #trial.suggest_float("logit_temp", 1.0, 2.6, step=0.2)  # {None, int >= 1}
    ...
    #reporter.add_metric_column('num_sat_sample_1')
    #reporter.add_metric_column('num_sat_sample_32')
    #reporter.add_metric_column('num_sat_sample_64')
