...
def pg_hypersearch(instance_dir,
    ...
    assumptions = [['arch', 'baseline', 'node2vec']]
    ...
    for assumption in assumptions:
        ...
        def define_by_run_func(trial):
            ...
            if decoder == "Transformer":
                ...
                trial.suggest_categorical("hidden_size", [1024])
                trial.suggest_categorical("trainable_state", [True])
            ...
            trial.suggest_categorical("clip_grad", [0.5, 1, 1.5, 2])
...
for i in lista:
    ...
    n2v_exp_name='test_node2vec'
    n2v_dir = 'test_node2vec_emb'
